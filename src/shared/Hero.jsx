    ...
    return (
        <motion.div
            ...
            <div className="lg:w-1/2">
                {/* <h1 className="font-bold text-6xl mb-6 leading-tight">Unlock Your Academic Potential with <span className="text-blue-600">TutorHive</span></h1> */}
