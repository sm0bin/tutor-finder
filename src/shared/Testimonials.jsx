            ...
            <div className="grid mb-8 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2">
                <figure className="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-tl-lg md:border-r dark:bg-gray-800 dark:border-gray-700">
                    <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                        ...
                        <p className="my-4">I was impressed with the quality of tutors on TutorHive. They helped me excel in my studies.</p>
                    </blockquote>
                ...
                <figure className="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-tr-lg dark:bg-gray-800 dark:border-gray-700">
                    <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                        ...
                        <p className="my-4">TutorHive helped me boost my grades significantly. The personalized guidance made a huge difference in my learning.</p>
                    </blockquote>
                    <figcaption className="flex items-center justify-center space-x-3">
                ...
                <figure className="flex flex-col items-center justify-center p-8 text-center bg-white border-b border-gray-200 rounded-bl-lg md:border-b-0 md:border-r dark:bg-gray-800 dark:border-gray-700">
                    <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                        ...
                        <p className="my-4">The tutors at TutorHive are experts in their subjects. I learned a lot and gained a deeper understanding of my coursework.</p>
                    </blockquote>
                    <figcaption className="flex items-center justify-center space-x-3">
                ...
                <figure className="flex flex-col items-center justify-center p-8 text-center bg-white rounded-b-lg md:rounded-br-lg dark:bg-gray-800 dark:border-gray-700">
                    <blockquote className="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                        ...
                        <p className="my-4">TutorHive offers fantastic support to both students and parents. They truly care about your academic success.</p>
                    </blockquote>
                    <figcaption className="flex items-center justify-center space-x-3">
