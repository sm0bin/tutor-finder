...
const About = () => {
    return (
        <section className="my-12">
            ...
            <h2 className="font-bold text-5xl text-blue-500 mb-8 leading-tight">Welcome to TutorHive,<br /> Where learning knows no bounds!</h2>
            ...
            <h2 className="font-bold text-3xl text-blue-500 mb-3 mt-12">Why TutorHive?</h2>
            <p className="text-gray-500 dark:text-gray-400 text-xl mb-8 leading-relaxed">
